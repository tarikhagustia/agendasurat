        ...
        <!-- Content Header (Page header) -->
          ...
          <section class="content">
            <div class="box box-info">
              ...
              <div class="box-body">
                <!-- form start -->
                <?php echo form_open('index.php/admin/insert_surat_keluar'); ?>
                  ...
                  <a href="<?php echo base_url(); ?>index.php/admin/surat_keluar" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Batal</a>
